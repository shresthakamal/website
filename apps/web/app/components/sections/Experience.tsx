...
export function Experience({ experiences }: ExperienceProps) {
  ...
  // Render Leadership & Community card
  const renderLeadershipCard = () => (
    <div className="bg-background rounded-2xl border border-border p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-primary/30 hover:scale-[1.02]">
      ...
      <p className="text-muted-foreground mb-6 leading-relaxed">
        Active involvement in academic communities, student organizations, and technology initiatives across multiple institutions.
      </p>

      {/* Key Achievements */}
      <div className="mb-4 sm:mb-6">
        <h4 className="text-xs sm:text-sm font-semibold text-foreground mb-2 sm:mb-3 uppercase tracking-wide">Key Roles</h4>
        <ul className="space-y-1 sm:space-y-2">
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">ACM - IIT Hyderabad Student Chapter - ML Moderator (11 months)</span>
          </li>
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">IT MEET v8.0 Documentation Lead and Marketing Representative</span>
          </li>
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">Executive Board Member at Kathmandu University Computer Club</span>
          </li>
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">Ambassador for Em-Blood Android Application with Nepal Red Cross</span>
          </li>
        </ul>
      </div>
      ...
      <div className="flex flex-wrap gap-1 sm:gap-2">
        <span className="px-2 sm:px-3 py-1 bg-muted/50 text-muted-foreground rounded-md text-xs font-medium hover:bg-primary/10 hover:text-primary transition-colors border border-border/50">
          Leadership
        </span>
        <span className="px-2 sm:px-3 py-1 bg-muted/50 text-muted-foreground rounded-md text-xs font-medium hover:bg-primary/10 hover:text-primary transition-colors border border-border/50">
          Community
  ...
  const renderVolunteerCard = () => (
    <div className="bg-background rounded-2xl border border-border p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-primary/30 hover:scale-[1.02]">
      ...
      <p className="text-muted-foreground mb-6 leading-relaxed">
        Dedicated volunteer work focused on community service, event coordination, and social initiatives with various organizations.
      </p>

      {/* Key Achievements */}
      <div className="mb-4 sm:mb-6">
        <h4 className="text-xs sm:text-sm font-semibold text-foreground mb-2 sm:mb-3 uppercase tracking-wide">Key Contributions</h4>
        <ul className="space-y-1 sm:space-y-2">
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">IT Meet Photography Contest Event Coordinator</span>
          </li>
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">Medical Volunteer for Basketball Tournament with Nepal Red Cross</span>
          </li>
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">Organized workshops and awareness campaigns</span>
          </li>
          <li className="flex items-start space-x-2 sm:space-x-3 text-xs sm:text-sm text-muted-foreground">
            <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
            <span className="leading-relaxed">Managed teams and secured funding for various initiatives</span>
          </li>
        </ul>
      </div>
    ...
    <section id="experience" className="py-24 px-4 sm:px-6 lg:px-8 bg-secondary/20">
      <div className="max-w-8xl mx-auto px-2 lg:px-8">
        ...
        <div className="relative w-full">
          ...
          <div className="absolute left-8 sm:left-10 md:left-1/2 md:transform md:-translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-primary/50 to-primary z-0"></div>
          ...
          <div className="space-y-8 md:space-y-12">
            {experiences.map((exp, index) => {
              ...
              return (
                <div key={index} className="relative flex items-center min-h-[120px]">
                  ...
                  <div className="absolute left-2 sm:left-4 md:left-1/2 md:transform md:-translate-x-1/2 z-20">
            ...
            {/* Leadership & Community Timeline Item */}
