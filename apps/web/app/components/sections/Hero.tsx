          ...
          <div className="text-center lg:text-left space-y-10 order-1 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:justify-start justify-center items-center">
              <button
                ...
                className="px-6 py-3 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors text-base"
                disabled={!mounted}
              >
                Learn More
              </button>
              <a
                ...
                className="px-6 py-3 bg-secondary text-secondary-foreground rounded-lg font-medium hover:bg-secondary/90 transition-colors text-base inline-flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-6 py-3 border border-border text-foreground rounded-lg font-medium hover:bg-accent transition-colors text-base"
                disabled={!mounted}
              >
                Get in Touch
              </button>
