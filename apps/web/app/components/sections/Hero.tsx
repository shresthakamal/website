        ...
        <div className="space-y-8">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
              ...
              <span className="text-foreground font-medium"> Natural Language Processing</span>, and 
              <span className="text-foreground font-medium"> Large Language Models</span> at BOSCH Global Software Technology.
            </p>
            <p className="text-base sm:text-lg text-muted-foreground">
              Passionate about advancing AI research and applying cutting-edge NLP solutions to real-world challenges.
            </p>
          </div>

          {/* Motto */}
          <div className="py-4">
            <blockquote className="text-lg sm:text-xl italic text-primary border-l-4 border-primary pl-4 max-w-md mx-auto">
