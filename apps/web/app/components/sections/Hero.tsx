          ...
          <div className="text-center lg:text-left space-y-10 order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:justify-start justify-center items-center">
              ...
              <a
                ...
                className="px-8 py-4 bg-secondary text-secondary-foreground rounded-lg font-medium hover:bg-secondary/90 transition-colors text-lg inline-flex items-center gap-2"
              >
